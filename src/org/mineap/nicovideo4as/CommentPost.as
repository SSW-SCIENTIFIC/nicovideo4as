package org.mineap.nicovideo4as {
     ...
     */ public class CommentPost extends EventDispatcher {
         ...
         * @author edvakf
         */
        public function postCommentWithLogin(mailAddress: String, password: String, videoId: String, comment: String, mail: String, vpos: int, is184: Boolean): void {
        ...
        private function getPostKeySuccess(event: Event): void {
            ...
            post(postKey, this._commentLoader.userID, this._ticket, this._mail, this._comment, this._vpos, this._thread, this._commentLoader.isPremium, this._commentLoader.messageServerUrl, this._resultCode, this._is184);
        }
         ...
         *
         */
        public function post(postKey: String, user_id: String, ticket: String, mail: String, comment: String, vpos: int, thread: String, isPremium: Boolean, messageServerUrl: String, resultCode: String, is184: Boolean): void {
