        ...
        public function analyze(xml: XML): Boolean {
            ...
            try {
                ...
                for each(var item: XML in channel.item) {
                    ...
                    var rankingItem: RankingItem = new RankingItem(HtmlUtil.convertSpecialCharacterNotIncludedString(item.title), item.link, item.guid, item.pubDate, item.description.text());
